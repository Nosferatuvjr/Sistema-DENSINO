...
<div class="box-content">
    <h2><i class="fa fa-calendar" aria-hidden="true"></i> Calendário e Agenda - <?php echo $nomeMes ?>/<?php echo $ano ?></h2>
    ...
    <form method="post" action="<?php echo INCLUDE_PATH_PAINEL ?>ajax/calendario.php">
        <div class="card-title">
            <h4>Adicionar Tarefa para o dia <?php echo $dataPrincipal; ?></h4>
        </div>
        <input required="" type="text" name="tarefa">
        <input type="hidden" name="data" value="<?php echo $dataPrincipal ?>" />
    ...
    <div class="box-tarefas">
        <div class="card-title">
            Tarefas de hoje: <?php echo $dataPrincipal; ?>
        </div>
        <?php
        ...
        ?>
            <div class="box-tarefas-single">
                <h2<i class="fa fa-rocket"></i> <?php echo $value['tarefa']; ?></h2>
            </div>
        <?php } ?>
        <div class="clear"></div>
    </div>
